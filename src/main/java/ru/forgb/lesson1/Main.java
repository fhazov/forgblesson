...
import static ru.forgb.lesson1.Utils.makeAnimalOlder;
...
public class Main {
    public static void main(String[] args) {
        ...
        Team team = new Team("Молодости нашей",
                new Cat("Морис", "black", 1),
                new Wolf("Тревор", "Серый", 6),
                new Cat("Барсик", "белый", 1),
                new Turtle("Черепаха", "зеленая", 100));  // Создаем команду
        team.getTeamInfo();
